...
def volum():
    call(["python", "1 volume control.py"])
                ...
                continue
                 ...
                 for i in result.multi_handedness:
                     ...
                     if label == 'Left':
                         ...
                         if (fingers[0] and fingers[1]) == 1 and (fingers[2] and fingers[3] and fingers[4]) == 0 :
                             for id, lm in enumerate(myhand.landmark):
                                 x = int(lm.x*fwidth)
                                 y = int(lm.y*fheight)
                                 ...
                                 if id == 8:
                                     cv2.circle(img,center = (x,y),radius = 20,color = (0,255,0))
                                     index_x =swidth/fwidth*x
                                     index_y =sheight/fheight*y
                                     pyautogui.moveTo(index_x,index_y)

                                 if id == 4:
                                     cv2.circle(img,center = (x,y),radius = 20,color = (0,255,0))
                                     thumb_x = swidth/fwidth*x
                                     thumb_y = sheight/fheight*y
